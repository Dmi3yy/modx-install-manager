...
$installPath = MODX_BASE_PATH .'install/';
$moduleName = "MODX";
$moduleVersion = $modx_branch.' '.$modx_version;
$moduleRelease = $modx_release_date;
$moduleSQLBaseFile = "setup.sql";
$moduleSQLDataFile = "setup.data.sql";
$chunkPath = $installPath .'/assets/chunks';
$snippetPath = $installPath .'/assets/snippets';
$pluginPath = $installPath .'/assets/plugins';
$modulePath = $installPath .'/assets/modules';
$templatePath = $installPath .'/assets/templates';
$tvPath = $installPath .'/assets/tvs';
